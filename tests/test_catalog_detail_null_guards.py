...
Cada `entry.kind` sem guard vira `Uncaught TypeError` relançado pelo Alpine —
o throw aborta o flush reativo e congela transições de modal no meio: o modal
"Declarar Divulgação" ficava fantasma (semi-transparente, sobreposto ao fundo)
e parecia quebrado/inutilizável.
