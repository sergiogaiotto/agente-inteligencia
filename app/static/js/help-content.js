    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          ...
          { title: 'Conversar ao vivo com o pipeline', body: 'Marque "Conversa (multi-turn ao vivo)" no builder: a tela vira um chat que faz chamadas reais ao /invoke reusando a sessão — você digita, o pipeline responde e lembra do turno anterior. É o "assistir funcionar" da receita de código; cada turno é 1 execução (custo de LLM).' },
